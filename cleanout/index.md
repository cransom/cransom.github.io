...
Reasonable offers accepted. This page will be updated if items are no longer available.


##  4x Juniper SRX210b (Dell branded)

From parting out my network lab. Before Dell had their own networking equipment, they relabeled other productions, including the Junipers. Despite the logo, they are run of the mill Juniper SRXs and are no different than any other Juniper labeled product.

Each has 2x GigE port and 6 10/100 ports. Each can be set up as a chassis cluster and is perfect for a low cost hardware setup for HA, routing and firewalling labs. Power cables included. Tested and verified all ports work. An easy to test out BGP/OSPF/etc on real hardware.

```
root> show chassis hardware
Hardware inventory:
Item Version Part number Serial number Description
Chassis AC3210AA0149 DELL J-SRX210B
Routing Engine REV 14 750-034241 AABX8799 RE-SRX210B
FPC 0 FPC
PIC 0 2x GE, 6x FE, 1x 3G
Power Supply 0

root> show version
Model: Dell J-SRX210B
...
It's a storage box with firewire, usb, and ethernet (ethernet is iSCSI only, no file sharing). It has 8 bays with (6) 1T drives.

[front](https://casey.hubns.net/p/clean/drobo-2.jpg)
